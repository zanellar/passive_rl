...
with open(run_results_file_path, 'a') as file: 
    line = f"{min_emin_ref_f1}, {max_emin_ref_f1}, {mean_emin_ref_f1}, {std_emin_ref_f1}"   
    file.write(line)
...
run_results_file_path = os.path.join(PkgPath.OUT_TRAIN_FOLDER,"run_results.txt")  
with open(run_results_file_path, 'a') as file: 
    line = f"{min_emin_ref_f01}, {max_emin_ref_f01}, {mean_emin_ref_f01}, {std_emin_ref_f01}"   
    file.write(line)
...
tester = TestRunEBud(Args)  
returns = tester.eval_returns_run(n_eval_episodes=50, save=True)
min_emin_ref_f001, max_emin_ref_f001, mean_emin_ref_f001, std_emin_ref_f001 = tester.eval_emin_run(n_eval_episodes=50, save=True)

run_results_file_path = os.path.join(PkgPath.OUT_TRAIN_FOLDER,"run_results.txt")  
with open(run_results_file_path, 'a') as file: 
    line = f"{min_emin_ref_f001}, {max_emin_ref_f001}, {mean_emin_ref_f001}, {std_emin_ref_f001}"   
    file.write(line)

################################################################################################
Args.RUN_ID = "etank_meanemin" 
Args.ENVIRONMENT = "pendulum_f001"  
Args.ENV_EXPL.energy_tank_init = mean_emin_ref_f001
Args.ENV_EVAL.energy_tank_init = Args.ENV_EXPL.energy_tank_init 
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Training {Args.RUN_ID} {Args.ENVIRONMENT}")
run(Args)
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Testing {Args.RUN_ID} {Args.ENVIRONMENT}")
...
run_results_file_path = os.path.join(PkgPath.OUT_TRAIN_FOLDER,"run_results.txt")  
with open(run_results_file_path, 'a') as file: 
    line = f"{min_emin}, {max_emin}, {mean_emin}, {std_emin}"   
    file.write(line)

################################################################################################
Args.RUN_ID = "etank_halfminemin" 
Args.ENVIRONMENT = "pendulum_f001"  
Args.ENV_EXPL.energy_tank_init = min_emin_ref_f001/2
Args.ENV_EVAL.energy_tank_init = Args.ENV_EXPL.energy_tank_init 
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Training {Args.RUN_ID} {Args.ENVIRONMENT}")
run(Args)
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Testing {Args.RUN_ID} {Args.ENVIRONMENT}")
...
################################################################################################
Args.RUN_ID = "etank_maxemin" 
Args.ENVIRONMENT = "pendulum_f001" 
Args.ENV_EXPL.energy_tank_init = max_emin_ref_f001
Args.ENV_EVAL.energy_tank_init = Args.ENV_EXPL.energy_tank_init 
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Training {Args.RUN_ID} {Args.ENVIRONMENT}")
run(Args)
print(f"{'@'*100}\n{'@'*100}\n{'@'*100}\n Testing {Args.RUN_ID} {Args.ENVIRONMENT}")
...
# Args.RUN_ID = "etank_meanmin_eaw" 
# Args.ENVIRONMENT = "pendulum_f001"  
# Args.ENV_EXPL.energy_tank_init = 0.22 #mean_emin_ref_f001 
# Args.ENV_EVAL.energy_tank_init = Args.ENV_EXPL.energy_tank_init
