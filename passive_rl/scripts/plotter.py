...
class PlotterEBud(Plotter):
    ...
    def multirun_energytank_train(self, env_run_ids, labels=[],  xsteps=False, smooth=False, save=True, show=True, plot_name=None, sub_folder_name="", ext="pdf", xlim=[None,None], ylim=[None,None], xlabels=None, ylabels=None):
    ...
    def multirun_energyexiting_train(self, env_run_ids, labels=[], etank_init_list=[],  xsteps=False, smooth=False, save=True, show=True, plot_name=None, sub_folder_name="", ext="pdf", xlim=[None,None], ylim=[None,None], xlabels=None, ylabels=None):
        if plot_name is None:
            plot_name = str(len(env_run_ids))
    ...
    def multirun_tanklevel_train(self, env_run_ids, labels=[], etank_init_list=[],  xsteps=False, smooth=False, save=True, show=True, plot_name=None, sub_folder_name="", ext="pdf", xlim=[None,None], ylim=[None,None], xlabels=None, ylabels=None):
        if plot_name is None:
            plot_name = str(len(env_run_ids))
    ...
    def multirun_poserror_train(self, env_run_ids, labels=[], xsteps=False, smooth=False, save=True, show=True, plot_name=None, sub_folder_name="", ext="pdf", xlim=[None,None], ylim=[None,None], xlabels=None, ylabels=None):
        if plot_name is None:
            plot_name = str(len(env_run_ids))
    ...
    def multirun_energytank_test(self, env_run_ids, labels=[], xlabels=None, ylabels=None, etank_init_list=[], save=True, show=True, sub_folder_name="", plot_name=None, plot_type="histplot", ext="pdf"): 
        if plot_name == None:
            plot_name = str(len(env_run_ids))
    ...
    def multirun_energyexiting_test(self, env_run_ids, labels=[], xlabels=None, ylabels=None , xsteps=False, smooth=False,  save=True, show=True, plot_name=None, sub_folder_name="", plot_type="histplot", ext="pdf", xlim=[None,None], ylim=[None,None], bootstrap=True): 
        if plot_name == None:
            plot_name = str(len(env_run_ids))
        run_paths_list = [os.path.join(self.out_test_folder, env_run) for env_run in env_run_ids]
        
        data = df_test_multirun_energy(run_paths_list=run_paths_list, smooth=smooth, run_label_list=labels ) 
        save_path = os.path.join(self.save_multirun_testing_plots_path, sub_folder_name, f"{plot_name}_{plot_type}_multirun_energyexiting_test.{ext}")
    ...
    def multirun_tanklevel_test(self, env_run_ids, labels=[], xlabels=None, ylabels=None, etank_init_list=[], save=True, show=True, plot_name=None, sub_folder_name="", plot_type="histplot", ext="pdf"): 
        if plot_name == None:
            plot_name = str(len(env_run_ids))
        run_paths_list = [os.path.join(self.out_test_folder, env_run) for env_run in env_run_ids]
    ...
    def multirun_poserror_test(self, env_run_ids, labels=[], xlabels=None, ylabels=None,  save=True, show=True, plot_name=None, sub_folder_name="", plot_type="histplot", ext="pdf"): 
        if plot_name == None:
            plot_name = str(len(env_run_ids))
        run_paths_list = [os.path.join(self.out_test_folder, env_run) for env_run in env_run_ids]
