...
plotter.multirun_energyexiting_test(env_run_ids = test_env_run_ids, labels = labels, ylabels = "Energy",  
                                show = False, sub_folder_name = sub_folder_name, plot_name = plot_name, ext = "pdf", xlim = [0,200], ylim = [0,3], xsteps = False, smooth=smooth)
...
plotter.multirun_tanklevel_train( env_run_ids = train_env_run_ids, labels = labels, etank_init_list = etank_init_list, 
                                show = False, sub_folder_name = sub_folder_name, plot_name = plot_name, ext = "pdf", xlim = [0,200], xsteps = False, smooth=smooth)
...
# plotter.multirun_energyexiting_test(env_run_ids = test_env_run_ids, labels = labels, ylabels = "Energy",  
#                                 show = False, sub_folder_name = sub_folder_name, plot_name = plot_name, ext = "pdf", xlim = [0,200], ylim = [0,10], xsteps = False, smooth=smooth)
