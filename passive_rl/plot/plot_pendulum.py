...
# plotter.plot_avg_train_multirun_energy(env_run_ids=env_run_ids, show=False)
# plotter.plot_avg_train_multirun_returns(env_run_ids=env_run_ids, show=False)
env_run_ids=["pendulum_f001/etank1000" ]
plotter.plot_boxes_test_multirun_energy(env_run_ids=env_run_ids, show=False)
